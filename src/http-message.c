 ...
 */
http_message_t http_message_create(int response_code, const char *response_string)
{
  http_message_t msg;
  int ret;
 ...
 */
int http_message_set_response(http_message_t msg, int response_code, const char *response_string)
{
  /* Check for valid arguments */
  if (msg == NULL)
    return -EFAULT;
 ...
 */
int http_message_add_headers(http_message_t msg, const char **headers, unsigned int num_headers)
{
